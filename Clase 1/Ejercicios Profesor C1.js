...
// B- Imprime tu nombre en la consola.
...
// B- Solicita al usuario que ingrese su edad y luego muestra un mensaje en la consola con esa edad.
// let edad = prompt("Ingresa tu edad: ");
// console.log ("La edad de " + nombreUsuario + " es de " + edad);
